---
id: 0009
title: Implement Physical AI Book Layout
stage: implement
date: 2025-12-09
surface: agent
...
files:
 ...
 - docs/01-prerequisites/_category_.json
 - docs/02-module-1-ros2/_category_.json
 - docs/03-module-2-simulation/_category_.json
 - docs/04-module-3-nvidia-isaac/_category_.json
 - docs/05-module-4-vla/_category_.json
 - docs/06-capstone-project/_category_.json
 - docs/07-appendix/_category_.json
...
- Next experiment (smallest change to try): Improve `create-new-feature.ps1` to handle Docusaurus initialization more robustly, possibly by creating a temporary empty directory and moving contents.
